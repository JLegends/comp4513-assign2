...
const GalleryInfo = (props) => {
    ...
    return (
        <div className="flex flex-col w-full h-full p-2 relative">
            {/* Background Image */}
            <div className="flex bg-black h-1/2 w-full rounded-xl shadow-lg px-2 py-2">
                {/* Overlay */}
                <div className="flex flex-col pl-4 w-[44%] pt-5 relative">
                    ...
                    <a href = {props.gallery.galleryWebSite} className="absolute -bottom-4 -left-4 text-black text-sm bg-button hover:bg-button-focus hover:text-white rounded-xl p-3 m-4 font-bold">Find More</a>
            ...
            <div className="flex justify-center items-center h-1/2 bg-black w-full rounded-xl mt-2 text-white "> Map
            </div>
            
            <img className="absolute top-[2.5%] right-5 rounded-full p-2 bg-black hover:bg-button-focus " src="./images/heart-icon.svg"/>
        </div>
    );
}
