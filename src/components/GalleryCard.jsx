const GalleryCard = ({gallery}) => {
    ...
    return (
        ...
        <div className="flex bg-[#1F1F1F] h-1/2 w-full rounded-xl shadow-lg px-3 py-3">
            ...
            <a href={gallery.galleryWebSite} className="absolute -bottom-4 -left-4 text-button-focus  text-sm bg-button hover:bg-button-focus hover:text-white rounded-xl p-3 m-4 font-bold">Learn More</a>
            </div>
            <img src={"./images/art-images/galleries/" + gallery.galleryId + '.jpg'} className="flex rounded-xl h-full w-1/2 translate-x-1/8 bg-black"/>
        </div>
    )
}
