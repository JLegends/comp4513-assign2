...
- **React Leaflet**: Integration of Leaflet maps for displaying gallery locations.
- **React Router**: Manages navigation between views in the single-page application.
- **Context API**: Manages global state for data and favorites.
...
1. **Clone the Repository**:
   ```bash
   git clone https://github.com/your-username/canvashub-development.git
   cd canvashub-development
...
- **National Gallery of Norwa**: https://www.nasjonalmuseet.no/globalassets/bilder/lokaler/nye-nm/national-museum-of-norway_photo-iwan-baan_2.jpg
